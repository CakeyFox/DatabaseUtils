...
data class AntiRaidModule(
    ...
    val messagesThreshold: Int = 10,
    val newUsersThreshold: Int = 5,
    val repeatedCharsThreshold: Int = 150,
    val warnsThreshold: Int = 5,
    val alertChannel: String? = null,
    val actionForMassJoin: String = "KICK",
    val actionForMassMessage: String = "WARN",
    val actionForMassChars: String = "WARN",
    val actionForMaxWarns: String = "TIMEOUT",
